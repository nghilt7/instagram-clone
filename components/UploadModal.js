        ...
        >
          <div className="flex flex-col justify-center items-center h-[100%]">
            ...
            <button
              ...
              className="w-full bg-red-600 p-2 text-white shadow-md hover:brightness-125 disabled:bg-gray-200 disabled:cursor-not-allowed disabled:hover:brightness-100"
            >
              Upload Post
            </button>
          </div>
